...
pandoc --verbose --filter pandoc-fignos --filter pandoc-crossref --filter pandoc-tablenos --citeproc --filter packages/pandoc-wrapfig/pandoc-wrapfig.py --bibliography lib/export_2023-3-16.bib --pdf-engine=xelatex --csl=templates/nature.csl --template=templates/default.latex paper.md -f markdown -t latex -s -o versions/paper_${1}.pdf
